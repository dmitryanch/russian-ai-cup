...
namespace Com.CodeGame.CodeWars2017.DevKit.CSharpCgdk
{
	...
	{
		public static int[] Cluster(Coordinate[] rawData, int numClusters)
		{
			// k-means clustering
		...
		private static double[][] Normalized(Coordinate[] rawData)
		{
			...
			for (int i = 0; i < rawData.Length; ++i)
			{
				...
				result[i][0] = rawData[i].X;
				result[i][1] = rawData[i].Y;
			}
