...
namespace Com.CodeGame.CodeWizards2016.DevKit.CSharpCgdk
{
	public sealed class MyStrategy : IStrategy
	{
		...
		private void AnalyzeTargets()
		{
			...
			_alert |= AllTargets.Length > AllTeam.Length;
		}
		...
		private void SetStuckAvoidingMovement()
		{
			...
			if (NearestUnits.Length > 1)
			{
				...
				{
					MoveOut(reverseVirtualNearest, withTurn: true);
				}
				return;
			}
		...
		private Route CurrentRoute
		{
			...
			{
				_сurrentRoute = value;
				if (!_oldNextRoutePoint.Equals(NextRoutePoint) || _world.TickIndex % 3 == 0)
				{
		...
		private const double NearestUnitsObservationRadius = 30;
